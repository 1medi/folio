...
export default function Section1() {
  return (
    <>
        <div className=" m-4 mx-8 justify-center bg-[#a49e8e80] rounded-lg items-center p-4 flex flex-col lg:flex-row xl:h-screen xl:flex-col xl:justify-around">
        ...
        <div className="snap-center snap-always flex flex-col lg:flex-row m-4 xl:h-screen xl:flex-col xl:justify-around xl:items-center xl:m-none">
          <div className="about p-8 bg-[#a49e8e80] rounded-lg m-4 lg:p-4 xl:p-12 lg:m-none desktop:p-24">
            ...
            <p className="p-4 lg:text-lg text-center">
              ...
              administrative burden many Canadians face—especially the millions
          ...
          <div className="proj-ideation p-8 bg-[#a49e8e80] rounded-lg m-4 lg:p-4 lg:m-none xl:p-12 desktop:p-24">
            ...
            <ul className=" text-center lg:text-lg xl:text-2xl xl:font-bold">
