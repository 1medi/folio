...
import BCELogo from "../../../public/projectLogos/bceLogo.webp";
      ...
      <Link href="/bc-ecosystems">
        ...
        >
          <div className="flex flex-row flex-wrap relative justify-center items-center">
            ...
            >
              <Image src={BCELogo.src} height={512} width={512} alt="lutong bahay" priority />
            </motion.div>
