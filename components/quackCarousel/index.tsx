...
export default function QuackCarousel({ showControls = false }) {
  ...
  const CarouselController = () => (
    <div className="flex justify-center items-center gap-8 mt-4 bg-[#3A3F2D] border rounded-md overflow-hidden w-full">
      <motion.div
        ref={carousel}
        drag="x"
        dragElastic={0.2}
