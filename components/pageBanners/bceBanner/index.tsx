        ...
        <div className="flex flex-col justify-center items-center">
          <div className="flex flex-col">
            ...
            <div className="text-center p-5">
              <h2 className="text-2xl font-semibold">Webpage</h2>
              <h2 className="text-xl font-medium">Completed: May 2025</h2>
            </div>
            <div className="flex flex-col w-2/3 justify-center items-center m-auto">
              ...
              >
                <a
                  href="https://www.bcecosystems.ca/"
                  target="_blank"
                >
                  <p className="text-2xl xl:text-4xl">Live Now!</p>
                </a>
              </motion.div>
            </div>
          </div>
